...
def create_axis_at_location(
    fig, left, bottom, width, height, transparent=False, box=True, ticks=True, **kwargs
):
    """
...
def create_legend_figure(
    ...
    plt.figlegend(
        handles, labels, loc="center", fontsize=fontsize, ncol=ncol, **legendargs
    )
